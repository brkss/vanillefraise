...
let UserPlan = class UserPlan extends typeorm_1.BaseEntity {
};
__decorate([
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => Plan_1.Plan, plan => plan.userplans, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
    }),
...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => User_1.User, user => user.userplans, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE'
    }),
