...
exports.CreatePlasResolver = void 0;
const type_graphql_1 = require("type-graphql");
const middlewares_1 = require("../../utils/middlewares");
const plans_1 = require("../../utils/responses/plans");
let CreatePlasResolver = class CreatePlasResolver {
...
], CreatePlasResolver.prototype, "createPlan", null);
CreatePlasResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], CreatePlasResolver);
exports.CreatePlasResolver = CreatePlasResolver;
